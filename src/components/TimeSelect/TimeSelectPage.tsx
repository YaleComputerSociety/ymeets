...
import { calanderState, userData, calendarDimensions, Availability } from '../../types'
import eventAPI from '../../firebase/eventAPI'
import { useNavigate, useParams } from 'react-router-dom'
import { getAccountId, getAccountName, getAvailabilityByAccountId, getAvailabilityByName, getEventOnPageload, wrappedSaveParticipantDetails, getEventName, getEventDescription, getLocationOptions, getParticipantIndex, checkIfLoggedIn, getChosenDayAndTime } from '../../firebase/events'
            ...
            <div className="flex flex-col flex-wrap break-words text-wrap justify-center content-center md:flex-row md:mx-12">
                ...
                <div className="flex flex-col flex-wrap justify-start sm:pt-12 md:w-[45%] md:pr-10 w-[100%] md:content-center">
                    <div className="mb-2">
                        ...
                        <h3 className="text-xl sm:text-3xl font-bold text-wrap text-left w-[100%] mb-4 mt-0">{eventName}</h3>
                    </div>

                    {eventDescription && (
                        <div className="mb-6">
                            <h3 className="text-m text-left text-gray-400 w-[100%] mb-0">Description</h3>
                            <h3 className="text-xl sm:text-2xl font-bold text-left text-wrap w-[100%] mb-4 mt-0">{eventDescription}</h3>
                        </div>
                    )}
