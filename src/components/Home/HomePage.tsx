        ...
        >
          <div className="justify-center self-center space-y-12 mt-3 max-w-full mb-4 min-w-[70%] md:w-[90%]">
            <div className="flex flex-col space-y-5 sm:space-y-10 w-full md:justify-end">
              <h1 className="font-bold text-center text-4xl sm:text-5xl md:text-left xl:text-5xl md:pr-8">
                A cleaner, faster way to schedule meetings.
              </h1>
              <h3 className="text-gray-600 text-center text-xl sm:text-3xl md:text-left xl:text-3xl md:pr-8">
                ymeets is a platform to plan gatherings at Yale more efficiently
              </h3>
            </div>
            <div
            ...
            >
              ...
              <button
                className={
                  !showInput
                    ? "hidden"
                    : "font-bold rounded-full bg-white text-black py-3 px-5 text-md transform transition-transform hover:scale-90 active:scale-100 mb-4"
                }
                onClick={() => {
                  showEventInput();
                }}
              ...
              >
                ...
                <input
                  className="rounded-l-full text-center py-4 px-4 text-lg focus:outline-blue-500 autofill:shadow-innerColor"
                ...
                <div
                  className={
                    !showFormValidation
                      ? "hidden"
                      : "text-blue-500 absolute -bottom-10 text-center w-full"
                  }
                >
