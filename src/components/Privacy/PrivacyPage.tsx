  ...
  return (
    <div className="bg-sky-100 ml-20 mr-20">
      ...
      <h1 className="text-xl">
        ymeets is an app designed to make group scheudling more convenient,
        tailored to the Yale community. To accomplish this goal, we collect some
        data from your Google Account and Calendar if you chose to log in with
        Google.
      </h1>
      ...
      <p className="text-xl">
        This application makes requests to your Google Calendar to pull in
        information about your events to learn times you may be unavailable.
        This information is unaccessible to the developers and is not stored in
        ...
        parties, except this site does include google analytics which records
        anonymized browsing behaviour.
        <br></br>
        <br></br>
        If you are not the person creating the event, you do not need to log in
        with Google at all!
        <br></br>
        <br></br>
        <strong>
          By continuing to use this site, you accept this privacy policy in
          full. If you disagree with this policy, you must not use this site.
        </strong>
      </p>
      ...
      <div className="body">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ymeets.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          We at ymeets.com use Google Analytics to collect data. We use this
          data to understand how you use our website so we can improve its
          design and functionality.
        </p>
        <p>
          Google Analytics will process and collect your personal data (cookies
          and IP address) to give us information. Google Analytics will transfer
          your data to the United States and store it while we offer our
          service. To learn more about Google&apos;s data transfer policies,{' '}
        ...
        <p>
          ...
          regarding cookies, please contact us.
        </p>
        ...
        <p>
          ymeets complies with the Google API Services User Data Policy,
          including the Limited Use requirements. Here is a{' '}
          ...
          to Google&apos;s API Service Data Policy, if you wish to learn more
          about the constraints to which we comply.
        </p>
      </div>
    </div>
  )
