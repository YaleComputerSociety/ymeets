...
export default function CopyCodeButton({
  ...
  return (
    <button
      ...
      className={`text-sm lg:text-base flex items-center justify-center border font-medium py-0.5 sm:py-1 lg:py-1.5 px-5 rounded-lg transition-colors relative whitespace-nowrap w-[140px]
        ${copied
