...
export default function AutoDraftEmailButton({
  customEventCode,
  eventTitle,
  yourName,
  senderEmail,
  ...
  return (
    <button
      onClick={() => {
        const url = `https://ymeets.com/dashboard/${usedCode}`;
      ...
      className={`text-sm lg:text-base flex items-center justify-center bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-300 border border-slate-300 dark:border-gray-600 font-medium py-0.5 sm:py-1 lg:py-1.5 px-5 rounded-lg transition-colors relative ${className}`}
    >
