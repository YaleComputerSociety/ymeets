        ...
        <div className="flex bg-white rounded-xl h-16 w-[90%] px-5 sm:px-8 items-center justify-between shadow-lg">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden sm:block">
              {name && (
                <div className="relative inline-block">
                  <div className="text-gray-500 flex flex-row border border-gray-500 rounded-full w-fit h-fit px-2 lg:px-3 py-1 self-center transition drop-shadow-2xl text-xs lg:text-sm">
            ...
            <div className="relative">
              ...
              {menuState !== 'closed' && (
                <div
                  className={`absolute z-10 mt-2 w-44 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 right-0 transition-all duration-200 ease-out transform origin-top-right ${menuState === 'opening' ? 'scale-95 opacity-0' : 'scale-100 opacity-100'}`}
                >
                  <div
